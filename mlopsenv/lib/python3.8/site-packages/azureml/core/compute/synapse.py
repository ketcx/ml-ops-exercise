...
class SynapseCompute(ComputeTarget):
    ...
    def _initialize(self, workspace, obj_dict):
        ...
        auto_scale_enabled = (obj_dict['properties']['properties']['autoScaleProperties']['enabled']
                              if 'autoScaleProperties' in obj_dict['properties']['properties'] and
                              'enabled' in obj_dict['properties']['properties']['autoScaleProperties'] else None)

        max_node_count = (obj_dict['properties']['properties']['autoScaleProperties']['maxNodeCount']
                          if 'autoScaleProperties' in obj_dict['properties']['properties'] and
                          'maxNodeCount' in obj_dict['properties']['properties']['autoScaleProperties'] else None)

        min_node_count = (obj_dict['properties']['properties']['autoScaleProperties']['minNodeCount']
                          if 'autoScaleProperties' in obj_dict['properties']['properties'] and
                          'minNodeCount' in obj_dict['properties']['properties']['autoScaleProperties'] else None)

        auto_pause_enabled = (obj_dict['properties']['properties']['autoPauseProperties']['enabled']
                              if 'autoPauseProperties' in obj_dict['properties']['properties'] and
                              'enabled' in obj_dict['properties']['properties']['autoPauseProperties'] else None)

        auto_pause_in_minutes = (obj_dict['properties']['properties']['autoPauseProperties']['delayInMinutes']
                                 if 'autoPauseProperties' in obj_dict['properties']['properties'] and
                                 'delayInMinutes' in obj_dict['properties']['properties']['autoPauseProperties']
                                 else None)
