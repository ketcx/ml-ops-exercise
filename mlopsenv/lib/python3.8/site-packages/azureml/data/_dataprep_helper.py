...
def upload_dir(src_dir, remote_target_path, datastore, overwrite=False, show_progress=True):
...
def upload_files(files, datastore, relative_root=None, target_path=None, overwrite=False, show_progress=True):
...
def _upload_file(base_path, local_file_path, remote_target_path, datastore, overwrite=False):
    ...
    _get_engine_api().upload_file(
        UploadFileMessageArguments(base_path=base_path, local_path=local_file_path,
