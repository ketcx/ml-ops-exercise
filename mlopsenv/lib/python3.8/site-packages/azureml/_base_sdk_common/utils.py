...
def list_remove_empty_strings(input_list):
    """
    Removes the empty string, "", from input_list
    """
    return [item for item in input_list if item != ""]


def list_remove_none_object(input_list):
    """
    Removes the None object from input_list
    """
