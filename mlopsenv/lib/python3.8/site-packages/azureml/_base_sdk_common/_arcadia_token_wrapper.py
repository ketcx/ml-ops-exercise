...
class PyTokenLibrary:
    ...
    def get_access_token(resource):
        ...
        try:
            # Trying new token library first
            ...
            # Trying old token library now.
            token_library_old = sc._jvm.com.microsoft.spark.arcadia.tokenlibrary.TokenLibrary
            access_token = token_library_old.getAccessToken(resource)
            return access_token
