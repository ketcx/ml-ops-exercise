...
class DatasetOutputOptions(Model):
    ...
    :param source_globs:
    :type source_globs: ~swagger.models.GlobOptions
    :param path_on_datastore:
    :type path_on_datastore: str
    """

    _attribute_map = {
        'source_globs': {'key': 'SourceGlobs', 'type': 'GlobOptions'},
        'path_on_datastore': {'key': 'PathOnDatastore', 'type': 'str'},
    }

    def __init__(self, source_globs=None, path_on_datastore=None):
        super(DatasetOutputOptions, self).__init__()
