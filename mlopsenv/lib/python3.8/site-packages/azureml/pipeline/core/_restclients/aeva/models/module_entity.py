...
class ModuleEntity(Model):
    ...
    _attribute_map = {
        ...
        'cloud_settings': {'key': 'CloudSettings', 'type': 'str'},
    ...
    def __init__(self, module_execution_type=None, module_type=None, upload_state=None, is_deterministic=None, structured_interface=None, data_location=None, identifier_hash=None, tags=None, properties=None, created_by=None, runconfig=None, cloud_settings=None, category=None, step_type=None, name=None, hash=None, description=None, entity_status=None, id=None, etag=None, created_date=None, last_modified_date=None):
