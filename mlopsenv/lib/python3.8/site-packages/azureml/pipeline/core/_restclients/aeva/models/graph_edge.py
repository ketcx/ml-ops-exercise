...
class GraphEdge(Model):
    ...
    :type source_output_port: ~swagger.models.PortInfo
    :param destination_input_port:
    :type destination_input_port: ~swagger.models.PortInfo
    """
    ...
    def __init__(self, source_output_port=None, destination_input_port=None):
