...
class RunConfiguration(Model):
    ...
    :param script: The relative path to the python script file, or command.
     The file path is relative to the source_directory passed to submit run.
    :type script: str
    :param command: Command to run with its argument in a list
