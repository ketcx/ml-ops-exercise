...
class ArmTemplateDto(Model):
    ...
    def __init__(self, workspace_name=None, location=None, is_byo_storage=None, byo_storage_arm_id=None, byo_acr_arm_id=None, byo_key_vault_arm_id=None, byo_app_insight_arm_id=None, is_byo_acr=None, is_byo_key_vault=None, is_byo_app_insights=None, provision_storage_behind_private_endpoint=None, provision_storage_behind_service_endpoint=None, provision_key_vault_behind_private_endpoint=None, provision_key_vault_behind_service_endpoint=None, cmk_keyvault_uri=None, cmk_keyvault_arm_id=None, adb_workspace_arm_id=None, is_hbi_workspace=None, sku=None, auto_approve_private_endpoint=None, manual_approve_private_endpoint=None, properties=None, compute_name=None, compute_type=None, aml_compute_admin_user_name=None, aml_compute_admin_user_password=None, aml_compute_vm_size=None, aml_compute_min_node_count=None, aml_compute_max_node_count=None, compute_instance_vm_size=None, compute_instance_assigned_user_object_id=None, compute_instance_assigned_user_tenant_id=None, attach_aks_cluster_arm_id=None):
