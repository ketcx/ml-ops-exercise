...
class MiroProxyInput(Model):
    ...
    def __init__(self, iteration=None, total_iterations=None, run_algorithms=None, run_preprocessors=None, iteration_numbers=None, metric_operation=None, dynamic_whitelist_setting=None, trace_id=None, pipeline_ids=None, scores=None, acquisition_function=None, acquisition_param=None, metric=None, max_cores_per_iteration=None, num_recommendations=None, time_constraint=None, num_categorical=None, num_features=None, num_classes=None, num_samples=None, task=None, predicted_times=None, actual_times=None, training_percents=None, cost_mode=None, is_sparse_data=None, model_names_whitelisted=None, model_names_blacklisted=None, subsampling=None):
