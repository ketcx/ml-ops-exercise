...
class Workspace(Resource):
    ...
    def __init__(self, identity=None, location=None, tags=None, sku=None, description=None, friendly_name=None, key_vault=None, application_insights=None, container_registry=None, storage_account=None, discovery_url=None, encryption=None, hbi_workspace=False, image_build_compute=None, allow_public_access_when_behind_vnet=False, shared_private_link_resources=None, service_managed_resources_settings=None):
