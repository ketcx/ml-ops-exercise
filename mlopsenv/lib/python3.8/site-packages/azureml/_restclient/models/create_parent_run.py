...
class CreateParentRun(Model):
    ...
    def __init__(self, run_type=None, run_source=None, num_iterations=None, training_type=None, acquisition_function=None, metrics=None, primary_metric=None, train_split=None, acquisition_parameter=None, num_cross_validation=None, target=None, aml_settings_json_string=None, data_prep_json_string=None, enable_subsampling=None, properties=None, scenario=None, parent_run_id=None):
