...
from azureml.core.script_run_config import get_run_config_from_script_run, ScriptRunConfig, _update_args_and_io
...
class HyperDriveConfig(object):
    ...
    def __init__(self,
        ...
        if hyperparameter_sampling is None:
            raise HyperDriveConfigException("'hyperparameter_sampling' argument is mandatory")
