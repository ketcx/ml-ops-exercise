...
from azureml.train.hyperdrive.exceptions import HyperDriveNotImplementedException
...
class HyperDriveRun(Run):
    ...
    def __init__(self, experiment, run_id, hyperdrive_config=None):
        ...
        if not isinstance(run_id, str):
            raise UserErrorException("RunId must be a string")
    ...
    def get_diagnostics(self):
        ...
        """
        raise HyperDriveNotImplementedException("Get diagnostics is unsupported for HyperDrive run.")
    ...
    def fail(self):
        ...
        :raises azureml.train.hyperdrive.exceptions.HyperDriveNotImplementedException:
        """
        raise HyperDriveNotImplementedException("Fail is unsupported for HyperDrive run.")
