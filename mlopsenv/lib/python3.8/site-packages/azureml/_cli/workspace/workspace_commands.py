...
def create_workspace(workspace_name, resource_group_name=None, location=None,
                     ...
                     container_registry=None, adb_workspace=None, cmk_keyvault=None,
                     resource_cmk_uri=None, hbi_workspace=False, create_resource_group=None,
                     exist_ok=False, sku='basic', tags=None, pe_name=None, pe_vnet_name=None,
    ...
    workspace_object = Workspace.create(workspace_name, auth=auth, subscription_id=default_subscription_id,
                                        ...
                                        container_registry=container_registry, adb_workspace=adb_workspace,
                                        cmk_keyvault=cmk_keyvault, resource_cmk_uri=resource_cmk_uri,
                                        hbi_workspace=hbi_workspace, exist_ok=exist_ok, sku=sku,
...
TAGS = argument.Argument("tags", "--tags", "", help="Tags associated with this workspace with 'key=value' syntax.",
                         required=False)
...
def update_workspace(
    ...
    return workspace.update(friendly_name=friendly_name, description=description, tags=get_tags_dict(tags),
