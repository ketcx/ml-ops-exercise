...
from azureml.automl.core._run import RunType, AbstractRun
from azureml.automl.core.automl_utils import service_exception_handler
from azureml.automl.core.shared import logging_utilities, utilities as common_utilities
...
@service_exception_handler(raise_exception=False)
def fail_run(run: RunType, exception: BaseException, is_aml_compute: bool = True) -> None:
    """
